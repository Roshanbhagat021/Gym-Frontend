    ...
    <div>
      ...
      <DataTable
        ...
        columns={[
          ...
          { key: 'price', header: 'Base price', render: (row) => <div><p className="font-bold">{currency(row.price)}</p><p className="text-xs text-steel">+ 5% GST</p></div> },
