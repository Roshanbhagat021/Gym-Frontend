...
export const Input = forwardRef(function Input({ className = '', ...props }, ref) {
  return (
    <input
      ref={ref}
      className={`min-h-11 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm outline-none transition focus:border-ember focus:ring-4 focus:ring-ember/10 dark:border-white/10 dark:bg-white/10 ${className}`}
      {...props}
    />
  );
});
